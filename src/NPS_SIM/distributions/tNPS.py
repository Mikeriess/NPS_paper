def simulate_NPS(case_topicidx, y, seed, F_NPS_dist_bias=0, F_tNPS_wtime_effect_bias=1.0):
    ...
    if F_NPS_dist_bias !=0:
        intercept = intercept + F_NPS_dist_bias
    
    #normalscale = 2.3027043599
    
    #coefficients
    base_log_throughputtime_coef = -0.0098232
    
    # Apply the tNPS_bias multiplier to the log_throughputtime coefficient
    betas = [base_log_throughputtime_coef * F_tNPS_wtime_effect_bias, #log_throughputtime with bias
             -0.12910, #d2
             0.100756, #g1
             0.085297, #j1
             -0.042748, #q3
