...
def CaseArrival(i, D, P_scheme, startdate, seed):
    ...
    for step in range(0,10000000000000):
        ...
        #predict rt and nps
        from queue_prioritization.models.NPS import predict_NPS_Notopic, predict_NPS
        from queue_prioritization.models.throughput import predict_TT_Notopic, predict_TT
